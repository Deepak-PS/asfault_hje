...
class TestExecution:
    ...
    def to_dict(execution):
        ...
        dic['maximum_acceleration'] = execution.maximum_acceleration
        dic['maximum_jerk'] = execution.maximum_jerk
        dic['average_acceleration'] = execution.average_acceleration
        dic['seg_hje_count'] = execution.seg_hje_count
    ...
    def from_dict(test, execution_dict):
        ...
        if 'hjes' not in execution_dict:
            execution_dict['hjes'] = 0
        exec = TestExecution(test, execution_dict['result'], execution_dict['reason'], states, execution_dict['oobs'], execution_dict['hjes'],
        ...
        if 'hjes' in execution_dict:
            exec.hjes = execution_dict['hjes']
        if 'seg_hje_count' in execution_dict:
            exec.seg_hje_count = execution_dict['seg_hje_count']
        if 'maximum_acceleration' in execution_dict:
            exec.maximum_acceleration = execution_dict['maximum_acceleration']
        if 'average_acceleration' in execution_dict:
            exec.average_acceleration = execution_dict['average_acceleration']
    ...
    def __init__(self, test, result, reason, states, oobs, start_time, end_time,
        ...
        self.states = states
        self.oobs = oobs
        self.hjes = options.get('hjes', None)
        ...
        self.seg_hje_count = options.get('seg_hje_count', None)
        self.maximum_acceleration = options.get('maximum_acceleration', None)
        self.maximum_jerk = options.get('maximum_jerk', None)
        self.average_acceleration = options.get('average_acceleration', None)
